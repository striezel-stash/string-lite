...
%gpp% -std=%std% %optflags% %warnflags% %unit_config% -o %unit_file%-main.t.exe -I../../string-view-lite/include -isystem lest -I../include -Ics_string -I. %unit_file%-main.t.cpp %unit_file%.t.cpp && %unit_file%-main.t.exe
